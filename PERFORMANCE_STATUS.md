...
- Готовность к commit/push: **PUBLISHED** 2026-07-31 — feature `ffd524aa`, plesk `6f31dd8c`; live https://raskrutov.kz/ содержит `rk-lcp-hero` / woff2 / perf-img
...
| После этапов 3–9 (PSI 2026-07-31 17:53) | ПК | **62** | **0,5 с** | **0,8 с** | **530 мс** | **0,262** | 1,6 с |
| После этапов 3–9 (PSI 2026-07-31) | Мобильный | **89** | **1,8 с** | **3,4 с** | **90 мс** | **0,004** | 3,8 с |

> Mobile: сильный рост (72→89), CLS почти идеален. Desktop: LCP/FCP лучше, но TBT и CLS ухудшились → Performance 66→62. Цель mobile LCP &lt;2,5 с ещё не достигнута (3,4 с).
